            ...
            <div class="card-body flex flex-col md:flex-row justify-between items-center gap-4">
                ...
                <div>
                    ...
                    <p class="text-sm my-3 opacity-90 flex items-center gap-2 ml-1">
                        ...
                        {{ $student->created_at->format('d M Y') }} থেকে আমাদের সাথে সংযুক্ত রয়েছেন
                    </p>
                </div>
                ...
                <div class="card-body">
                    ...
                    <div class="grid grid-cols-3 gap-4 mt-4 text-center">
                        ...
                        <div class="bg-warning/10 rounded-lg p-3">
                            <p class="text-sm">প্রক্রিয়াধীন</p>
            ...
            <div class="card bg-base-100 shadow-xl border-l-8 border-secondary">
                <div class="card-body">
                    <div class="flex justify-between items-center">
                        ...
                        <span class="badge badge-secondary badge-lg">৳100000</span>
                    </div>
                    ...
                    <div class="space-y-2 mt-4">
                        ...
                        <div class="flex justify-between bg-base-200 p-2 rounded">
                            <span>বিগত বছর</span>
                            <span class="font-semibold">৳8000</span>
                        </div>
                    </div>
                </div>
            </div>
