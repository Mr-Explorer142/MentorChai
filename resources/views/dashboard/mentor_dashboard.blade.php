            ...
            <div class="card-body flex flex-col md:flex-row justify-between items-center gap-4">
                ...
                <div>
                    ...
                    <p class="text-sm my-3 opacity-90 flex items-center gap-2 ml-1">
                        ...
                        {{ $mentor->created_at->format('d M Y') }} হতে আমাদের সাথে সংযুক্ত রয়েছেন
                    </p>
                </div>

                <div class="avatar">
                    <div class="w-16 rounded-full ring ring-white ring-offset-2 ring-offset-primary">
                        <img src="https://ui-avatars.com/api/?name={{ urlencode($mentor->name) }}&background=0D8ABC&color=fff"
                            alt="Student Avatar">
                    </div>
                </div>
            </div>
            ...
            <div class="card bg-base-100 shadow-xl border-l-8 border-secondary">
                <div class="card-body">
                    <div class="flex justify-between items-center">
                        ...
                        <span class="badge badge-secondary badge-lg">৳10000</span>
                    </div>

                    <div class="space-y-2 mt-4">
                        <div class="flex justify-between bg-base-200 p-2 rounded">
                            <span>বিগত সপ্তাহ</span>
                    ...
                    <table class="table table-zebra">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td><span class="badge badge-info">2 ঘন্টা</span></td>
                            ...
                            <tr>
                                ...
                                <td>আনিসুল ইসলাম</td>
                                <td>API Design</td>
                                <td><span class="badge badge-warning">1.5 ঘন্টা</span></td>
                            ...
                            <tr>
                                ...
                                <td><span class="badge badge-secondary">2 ঘন্টা</span></td>
                                <td class="font-semibold">৳1200</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
                    ...
                    <table class="table table-zebra">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>সাদিবুল হাসান</td>
                                <td class="font-semibold">৳1000</td>
                                <td><span class="badge badge-primary">বিকাশ</span></td>
                            ...
                            <tr>
                                ...
                                <td>আনিসুল ইসলাম</td>
                                <td class="font-semibold">৳750</td>
                                <td><span class="badge badge-warning">নগদ</span></td>
                                <td>12 September 2026</td>
                            </tr>
                            <tr>
                                <td>18</td>
                                <td>রিফাত হাসান</td>
                                <td class="font-semibold">৳1200</td>
                                <td><span class="badge badge-info">ব্যাংক</span></td>
                                <td>12 September 2026</td>
                            </tr>
                        </tbody>
                    </table>
