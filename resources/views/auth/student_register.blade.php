    ...
    <div class="my-10 flex items-center justify-center p-3">
        <form action="{{ route('register') }}" method="POST">
            ...
            <fieldset class="fieldset bg-base-200 border-base-300 rounded-box w-xs border p-4">
                ...
                <p class="text-center my-5 leading-loose font-semibold">মেন্টর হিসেবে যুক্ত হতে চান?</p>

                <a class="btn btn-success btn-outline mb-3 text-center text-md font-semibold text-md fw-bold"
                    href="{{ route('teacher_register') }}">মেন্টর আকাউন্ট খুলুন</a>
