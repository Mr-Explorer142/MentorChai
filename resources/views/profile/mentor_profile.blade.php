                ...
                <div class="flex flex-col lg:flex-row gap-6 items-center lg:items-start">
                    ...
                    <div class="flex-1 text-center lg:text-left">
                        ...
                        <p class="font-medium text-sm text-base-content/60 my-2">
                            ইউজার আইডি : {{ $mentor->id }}
                        </p>

                        <!-- Bio -->
                        <p class="font-medium text-base-content/70 max-w-xl">
                            {{ $mentor->profile->bio ?? 'এখনো শর্ট বায়ো যোগ করা হয়নি' }}
                        </p>
                    </div>
        ...
        <div class="mx-auto card bg-base-100 shadow-sm">
            ...
            <div class="card-body">
                <div class="flex items-center justify-between mb-6">
                    <h2 class="text-lg font-semibold">ছাত্রদের রিভিউ</h2>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="card bg-base-100 border shadow-sm">
                        <div class="card-body gap-3">
                            ...
                            <p class="text-sm text-base-content/70">
                                বিষয়গুলো খুব পরিষ্কারভাবে বুঝিয়েছেন। জটিল টপিকও সহজ করে বোঝানোর ধরনটা দারুণ লেগেছে।
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="card bg-base-100 border shadow-sm">
                        <div class="card-body gap-3">
                            ...
                            <p class="text-sm text-base-content/70">
                                প্রতিটি সেশন ছিল গোছানো ও কাজে লাগার মতো। বাস্তব প্রজেক্টে কাজ করার আত্মবিশ্বাস পেয়েছি।
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="card bg-base-100 border shadow-sm">
                        <div class="card-body gap-3">
                            ...
                            <p class="text-sm text-base-content/70">
                                খুব বন্ধুসুলভ এবং প্রফেশনালভাবে গাইড করেছেন। প্রশ্ন করলে সবসময় ধৈর্য ধরে উত্তর দিয়েছেন।
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="card bg-base-100 border shadow-sm">
                        <div class="card-body gap-3">
                            ...
                            <p class="text-sm text-base-content/70">
                                শেখানোর গতি আর ব্যাখ্যা দুটোই ভালো। নতুনদের পাশাপাশি মাঝামাঝি লেভেলের শিক্ষার্থীদের
                                জন্যও উপকারী।
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="card bg-base-100 border shadow-sm">
                        <div class="card-body gap-3">
                            ...
                            <p class="text-sm text-base-content/70">
                                বিষয় সম্পর্কে গভীর ধারণা আছে এবং বোঝানোর স্টাইলও চমৎকার। যারা সিরিয়াসলি শিখতে চায়, তাদের
                                জন্য খুব ভালো।
                            </p>
                        </div>
                    </div>
