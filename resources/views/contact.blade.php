<x-layout>
    <div class="min-h-screen bg-base-200 px-6 md:px-18 space-y-6">
        ...
        <section class="max-w-7xl mx-auto px-6 py-20">
            <h2
                class="text-3xl font-bold text-center mb-12 text-primary">
                যোগাযোগ করুন 
            </h2>
                ...
                <div class="w-full md:w-1/2 order-2 md:order-1 mt-8 md:mt-0">
                    <div class="grid grid-cols-1 gap-4">
                        ...
                        <div
                            ...
                            <div>
                                <p class="font-semibold">মোবাইল</p>
                        ...
                        <!-- Email -->
                        <div
                            class="relative p-5 rounded-xl shadow-md border-l-4 border-pink-500 cursor-pointer
                                    transition-transform duration-300 hover:-translate-y-1 hover:shadow-lg flex items-center gap-4">
                            <button
                                class="copy-btn absolute top-2 right-2 text-gray-400 hover:text-gray-700 transition text-lg"
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 text-pink-500" fill="none"
                                viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round"
                        ...
                        <div
                            ...
                            <div>
                                <p class="font-semibold">টেলিগ্রাম / ওয়াটস্যাপ</p>
                                <p class="text-sm opacity-70">+8801122334455</p>
                            </div>
                        </div>
                        ...
                        <!-- Location -->
                        <div
                            class="relative p-5 rounded-xl shadow-md border-l-4 border-yellow-500 cursor-pointer
                                    transition-transform duration-300 hover:-translate-y-1 hover:shadow-lg flex items-center gap-4">
                            <button
                                class="copy-btn absolute top-2 right-2 text-gray-400 hover:text-gray-700 transition text-lg"
                ...
                <div class="w-full md:w-1/2 order-1 md:order-2">
                    <div class="rounded-xl shadow-md p-6">
                       ...
                       placeholder-gray-500 focus:border-blue-500 focus:outline-none" />
                            ...
                            <textarea rows="5" placeholder="মেসেজ লিখুন"
            ...
            <div class="mt-14 text-center">
                <h3 class="text-center font-semibold mb-4 text-base-content">আমাদের খুঁজে পেতে গুগল ম্যাপের সহায়তা নিন</h3>
